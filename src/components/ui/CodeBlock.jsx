  ...
  return (
    <div className="group relative my-4 rounded-xl bg-gray-50 overflow-hidden">
      <div className="flex items-center justify-between px-4 py-2 border-b border-gray-200 bg-gray-100/50">
        <span className="text-xs font-medium text-gray-500 uppercase font-mono">
          {language || 'text'}
        </span>
        <button
          onClick={handleCopy}
      ...
      <div className="overflow-x-auto p-4 bg-white/50">
        <code className={`${className} !bg-transparent !p-0 text-sm font-mono text-gray-800 leading-relaxed block`} {...props}>
          {children}
        </code>
      </div>
    </div>
